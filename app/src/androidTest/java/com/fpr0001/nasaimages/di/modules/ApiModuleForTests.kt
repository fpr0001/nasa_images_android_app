...
open class ApiModuleForTests {
    ...
    @Provides
    @Singleton
    open fun providesNasaApi(impl: NasaApiImplForTests): NasaApi {
        return impl
    }

    @Provides
    @Singleton
    open fun providesNasaApiImpl(gson: Gson): NasaApiImplForTests {
...
class NasaApiImplForTests(gson: Gson) : NasaApi {
